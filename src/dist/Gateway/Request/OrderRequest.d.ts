export = OrderRequest;
declare class OrderRequest extends TransactionRequest {
    /**
     * @inheritDoc
     *
...
import AbstractPaymentMethod = require("./PaymentMethod/AbstractPaymentMethod");
import BrowserInfo = require("./Model/ThreeDSTwo/BrowserInfo");
