...
class TransactionMapper extends AbstractMapper {
    mapResponseToModel() {
        const values = {
            ...
            referenceToPay: typeof this.source.referenceToPay !== 'undefined' ? this.source.referenceToPay : null,
            ipAddress: typeof this.source.ipAddress !== 'undefined' ? this.source.ipAddress : null,
            ipCountry: typeof this.source.ipCountry !== 'undefined' ? this.source.ipCountry : null,
            deviceId: typeof this.source.deviceId !== 'undefined' ? this.source.deviceId : null,
            avsResult: typeof this.source.avsResult !== 'undefined' ? this.source.avsResult : null,
            ...
            paymentProduct: typeof this.source.paymentProduct !== 'undefined' ? this.source.paymentProduct : null,
            ...
            threeDSecure: typeof this.source.threeDSecure !== 'undefined' ? new ThreeDSecureMapper(this.source.threeDSecure).mappedObject : null,
            fraudScreening:
                typeof this.source.fraudScreening !== 'undefined' ? new FraudScreeningMapper(this.source.fraudScreening).mappedObject : null,
            order: typeof this.source.order !== 'undefined' ? new OrderMapper(this.source.order).mappedObject : null,
            debitAgreement: typeof this.source.debitAgreement !== 'undefined' ? this.source.debitAgreement : null,
            basket: typeof this.source.basket !== 'undefined' ? this.source.basket : null,
            operation: typeof this.source.operation !== 'undefined' ? new OperationResponseMapper(this.source.operation).mappedObject : null,
