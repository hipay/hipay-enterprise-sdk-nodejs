...
class OrderMapper extends AbstractMapper {
  mapResponseToModel() {
    let values = {
      ...
      customerId:
        typeof this.source.customerId !== 'undefined'
          ? this.source.customerId
          : null,
      amount:
        typeof this.source.amount !== 'undefined' ? this.source.amount : null,
      tax: typeof this.source.tax !== 'undefined' ? this.source.tax : null,
      shipping:
        typeof this.source.shipping !== 'undefined'
      ...
      dateCreated:
        typeof this.source.dateCreated !== 'undefined'
          ...
          : null,
      attempts:
        typeof this.source.attempts !== 'undefined'
      ...
      decimals:
        typeof this.source.decimals !== 'undefined'
          ...
          : null,
      gender:
        typeof this.source.gender !== 'undefined' ? this.source.gender : null,
      language:
        typeof this.source.language !== 'undefined'
          ? this.source.language
          : null,
      shippingAddress:
        typeof this.source.shippingAddress !== 'undefined'
          ? new PersonalInformationMapper(this.source.shippingAddress)
              .mappedObject
          : null,
